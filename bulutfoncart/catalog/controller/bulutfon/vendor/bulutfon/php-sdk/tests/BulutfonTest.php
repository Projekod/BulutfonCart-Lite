...
namespace Bulutfon\OAuth2\Client\Test\Provider;

use Mockery as m;

class BulutfonTest extends \PHPUnit_Framework_TestCase
{
    protected $provider;
    protected function setUp()
    {
        $this->provider = new \Bulutfon\OAuth2\Client\Provider\Bulutfon([

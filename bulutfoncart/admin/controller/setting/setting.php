...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_bulutfon_key'])) {
            $data['config_bulutfon_key'] = $this->request->post['config_bulutfon_key'];
        } else {
            $data['config_bulutfon_key'] = $this->config->get('config_bulutfon_key');
        }
        if (isset($this->request->post['config_bulutfon_secret'])) {
            $data['config_bulutfon_secret'] = $this->request->post['config_bulutfon_secret'];
        } else {
            $data['config_bulutfon_secret'] = $this->config->get('config_bulutfon_secret');
        }

        $data["config_bulutfon_url"] = "https://".$this->config->get('config_ftp_hostname')."/bulutfonauth.php";

        $data["bulutfonTab"] = $this->load->view('setting/bulutfontab.tpl',$data);
        //:bulutfoncart
